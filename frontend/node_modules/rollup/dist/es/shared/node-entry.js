...
class Graph {
    constructor(options, registerWatchHooks) {
        this.options = options;
        this.astLru = flru(5);
...
async function rollupInternal(rawInputOptions, registerWatchHooks) {
    const { options: inputOptions, unsetOptions: unsetInputOptions } = await getInputOptions(rawInputOptions, registerWatchHooks !== null);
...
export { VERSION, createFilter$1 as createFilter, defineConfig, fseventsImporter, getAugmentedNamespace, getDefaultExportFromCjs, rollup, rollupInternal, waitForAllAndRethrowFirstFailure, watch };
